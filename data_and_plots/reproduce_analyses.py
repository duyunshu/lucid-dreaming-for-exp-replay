...
def aggregate_fun(ex_type='', dictionary='sil', key='sil_ctr', result_folder='a3c',
    ...
    for data_idx in num_data:
        folder=('{}/{}/analyses/'.format(result_folder, game) + gym_env + \
...
################################################
ex_type = '_rawreward_transformedbell_sil_prioritymem_logging'
lider_ex_type = '_rawreward_transformedbell_sil_prioritymem_lider_logging'
